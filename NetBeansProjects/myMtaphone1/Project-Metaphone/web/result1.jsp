        ...
        <div id="container_result_page"> 
            ...
            <div id="header">
                ...
                <br><br>
                        ...
                        <form action="result1.jsp" method="get" name="fmr2" onsubmit="return isNull('form_error')"> 
                                    ...
                                    <tr><td>
                                            <div class="left_col_box">
                                                <div class="blog_box">
                                                    ...
                                                    <h3><div style="color:#380000;font-weight:bold;font-size:1.5em"><%=result%>  </div></h3>
