...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2014 at 02:56 AM
...
('CONC001', 'sagu', 5, '2014-12-05 00:00:10', '<p>new content<br></p>'),
('CONC003', 'sagu', 3, '2014-12-04 21:56:29', '<p>Very good concert, lively<br></p>'),
('CONC004', 'sagu', NULL, '2014-12-05 01:52:00', NULL),
('CONC005', 'sagu', NULL, '2014-12-05 01:53:32', NULL);
...
CREATE TABLE IF NOT EXISTS `concert` (
  ...
  UNIQUE KEY `ConcertID_2` (`ConcertID`),
  KEY `venueID` (`venueID`),
  KEY `BandID` (`BandID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, NULL, 'BND001', '2014-11-24 03:21:41', 'Hello New Yorkers!!.\r\nwe performing live at Barclay''s..\r\n\r\nStay tuned for more information..!!!'),
(2, 'MUH001', NULL, '2014-11-24 03:20:40', 'There is an awesome concert coming soon by New York Classic, Must watch!!..');
...
('MukulHodar', 'mukul123', 'mukul', 'hodarkar', '1991-05-06', 'Buffalo', 'muh205@nyu.edu', '2014-11-01 00:00:00', '2014-11-24 00:00:00'),
