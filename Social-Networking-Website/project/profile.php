...
if ($conn->connect_error)
{
	...
	$sql11 = "SELECT follower, following FROM follow WHERE follower = '$Username' AND following ='$user' ";
	//echo $sql11;
...
//echo"$fan";
	...
	$sql12 = "SELECT follower, following FROM follow WHERE following ='$user' ";
	$sql13 = "SELECT follower, following FROM follow WHERE follower ='$user' ";
	//echo $sql11;
	...
	{	
		...
		$follower = $row12["follower"];
		$following = $row12["following"];
		$followers++;
		}	
	//echo "follwoing: $followings";
	}
	...
	{	
		...
		$follower = $row13["follower"];
		$following = $row13["following"];
		
		$followings++;
		}
		//echo "follwers: $followers";	
	...
	$sql = "SELECT fName, lName, city FROM user WHERE Username = '$user'";
	//echo $sql;
					...
					<div>
						<div class="text">
							<div class="infoColumnUp">
								...
								<div class="infoColumnNumber"><div class="infoColumnNumberBg"><?php echo"$followings";?></div></div>
								<p>Following</p>
							</div>
							
							<div class="infoColumnDown">
								<div class="infoColumnIcon"><img src="./img/quick_info_down.png" alt="Down" /></div>
								<div class="infoColumnNumber"><div class="infoColumnNumberBg"><?php echo"$followers";?></div></div>
								<p>Followers</p>
							</div>
							<?php if ($show == 1) { ?>
								<div class="infoColumnUp">
								<a  href="follow.php?user=<?php echo"$user";?>"><img src="./img/quick_info_up.png" alt="Follow" /></a>
					...
					<div>
						<div class="text">
							<table class="">
								...
								<tbody>
								<?php
									$sql4 = "SELECT Content, dateTimeStamp FROM post WHERE username = '$user'";
									//echo $sql4;
					...
					<div>
						<table>
							...
							<tbody>
								...
								$sql3 = "SELECT ConcertID, concertName, datetime FROM concert WHERE  ConcertID in (select concertID from userlist where username = '$user')";
									//echo $sql3;
