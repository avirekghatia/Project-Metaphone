	  ...
	  if(isset($_GET['go'])){ 
		if(preg_match("/^[  a-zA-Z]+/", $_POST['name'])){ 
			  $name=$_POST['name']; 
				...
				$sql = "SELECT BandID, BandName, city, webpage  FROM band WHERE BandName = '$name'";
				//echo $sql;
				...
				<div class="dataGrid">
					...
					<div class="dataGridControl">
						<div class="dataGridControlButtons">
							<form  method="post" action="search_bands.php?go"  id="searchform"> 
					...
					<table>
						...
						<tbody>
							...
							<?php if(isset($_POST['submit'])){ ?>
								<td></td>
								<td><a  href="band_profile.php?BandID=<?php echo"$BandID";?>"><?php echo"$BandName";?></a></td>
								<td><?php echo"$webpage";?></td>
								<td><?php echo"$city";?></td>
							<!--/tr-->
							<?php } else {
							
									$sql1 = "SELECT BandID, BandName, city, webpage  FROM band";
									//echo $sql1;
