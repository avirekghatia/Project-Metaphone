...
<div id="bgTop">
	...
	<div id="core">
		...
		<form name="form1" method="post" action="band_result.php">
			<div id="content">
			
				<div class="box">
					<h2>Enter Your Band's Details </h2> 
					<div>
						...
						<div class="textField3">
							<div>Band Name</div>
							<input type="text" name="bName" placeholder="Band Name" value="" />
						</div>
						...
						<div class="textField3">	
							<div>City</div>
							<input type="text" name="city" placeholder="City of origin" value="" />
						</div>	
					
						<div class="textField3">	
							<div>Band's webpage</div>
							<input type="text" name="link" placeholder="hyperlink to band's webpage" value="" />
						</div>	
						<div class="textField3">
						</div>
						...
						<div class="textField">
							<div>Information</div>
							<input type="text" name="info" placeholder="Please enter information about band" value="" />
						</div>
					</div>
				</div>
